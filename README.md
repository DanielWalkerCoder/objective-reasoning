...
Write a function, `getEmail`, that given a user object, return the users' Persevere email. We'll assume that a Code Immersives email is always in `firstInitialLastName.prsvr@gmail.com` form.
